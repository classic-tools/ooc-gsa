...
l0:
  ...
  i1 = i7 == 0;
  if (i1) goto l3;
  i7 = SymbolTable__Unnamed((Data__Struct)i7);
  if (i7) goto l1;
  i7 = (int)*(void**)i0;
  i7 += 36;
  i7 = (int)*(void**)i7;
...
l2:
  i7 = i0 + 28;
  i1 = (int)*(void**)i7;
  SymbolFile__IntegrateSymbols_IntegrateTree_IntegrateList((Data__Object *)i7, &*SymbolFile__IntegrateSymbols_mid, &*SymbolFile__IntegrateSymbols_stripData, (Data__Object *)&*SymbolFile__IntegrateSymbols_IntegrateTree_o);
l3:
  i7 = i6 + 12;
  *(void**)i7 = (void*)0;
  i7 = i6 + 48;
  i0 = *SymbolFile__IntegrateSymbols_mid;
  *(short int*)i7 = i0;
...
l4:
  ...
  if (i1) goto l7;
  i0 = SymbolFile__IntegrateSymbols_IntegrateTree_IntegrateList_ObjIsPtrBase((Data__Object)i6);
  if (i0) goto l7;
  *SymbolFile__IntegrateSymbols_IntegrateTree_o = (void*)i6;
  i1 = i5 == 0;
  if (i1) goto l5;
  i1 = (int)*(void**)i3;
  i7 = i5 + 36;
...
l6:
  ...
  *(void**)i3 = (void*)0;
  ...
  i3 = i1 + 36;
  *(void**)i3 = (void*)0;
  i3 = (int)*SymbolFile__IntegrateSymbols_IntegrateTree_o;
  i1 = i3 + 40;
  *(void**)i1 = (void*)0;
  i1 = (int)*SymbolFile__IntegrateSymbols_IntegrateTree_o;
  i3 = i1 + 44;
...
l9:
  i7 = i6 + 44;
  i4 = (int)*(void**)i7;
  SymbolFile__IntegrateSymbols_IntegrateTree((Data__Object *)i7, &*SymbolFile__IntegrateSymbols_mid, &*SymbolFile__IntegrateSymbols_stripData);
l10:
  i5 = i6;
l11:
  i7 = i2 != 0;
...
l0:
  ...
  *(void**)i0 = (void*)i3;
  ...
  goto l0;
l1:
  SymbolFile__structArray = (void*)i2;
l2:
  i0 = (int)SymbolFile__structArray;
...
l0:
  ...
  *(int*)i3 = i1;
  ...
  i1 = (int)*SymbolFile__Write_WriteObject_obj;
  i1 = SymbolTable__LocalType((Data__Object)i1, (Data__Struct)(int)t);
  if (i1) goto l1;
  i0 = (int)t + 36;
  i3 = (int)*(void**)i0;
  i3 = (int)SymbolTable__Module((Data__Object)i3);
  i3 += 52;
  i1 = (int)*(void**)i3;
  ...
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i2)((BinaryRider__Writer)i3, (int)i1);
  i0 = (int)*(void**)i0;
  i0 += 20;
  i0 = (int)*(void**)i0;
  i1 = *(int*)(i0-8);
  i3 = (int)*SymbolFile__Write_w;
  SymbolFile__WriteString((BinaryRider__Writer)i3, (unsigned char*)i0, i1);
  goto l9;
l1:
  i1 = (int)*SymbolFile__Write_w;
  i3 = *(signed char*)i0;
...
l6:
  ...
  i0 = (int)((_Type)i0)->tbprocs[13];
  i3 = *(int*)i3;
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i0)((BinaryRider__Writer)i2, (int)i3);
  goto l9;
l7:
  i1 = (int)*SymbolFile__Write_w;
  i2 = *(int*)(i1-4);
  i2 = (int)((_Type)i2)->tbprocs[13];
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i2)((BinaryRider__Writer)i1, (int)i4);
  goto l9;
l8:
  i2 = (int)*SymbolFile__Write_w;
  i1 = *(int*)(i2-4);
...
l2:
  ...
  i1 &= 0xFFFU;
  i0 = (int)*SymbolFile__Write_w;
  SymbolFile__WriteFlags((BinaryRider__Writer)i0, (unsigned int)i1);
  i1 = (int)obj + 68;
  i1 = *(unsigned int*)i1;
  i1 &= 0x7FU;
  i0 = (int)*SymbolFile__Write_w;
...
l3:
  ...
  i1 = (int)obj + 52;
  i1 = (int)*(void**)i1;
  SymbolFile__Write_WriteObject((Data__Object)i1, (BinaryRider__Writer *)&*SymbolFile__Write_w);
  goto l9;
l4:
  i2 = (int)obj + 24;
  i2 = (int)*(void**)i2;
  ...
  i1 = (int)((_Type)i1)->tbprocs[13];
  i2 = *(int*)i2;
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i1)((BinaryRider__Writer)i0, (int)i2);
  goto l9;
l5:
  if (!((i2>=8 && i2<=9))) goto l6;
  i1 = (int)*SymbolFile__Write_w;
  i0 = (int)obj + 52;
  i2 = (int)*(void**)i0;
  i0 = *(int*)(i1-4);
  i2 += 40;
  i0 = (int)((_Type)i0)->tbprocs[15];
  d0 = *(double*)i2;
  ((_TBP_BinaryRider__WriterDesc_WriteLReal)i0)((BinaryRider__Writer)i1, (double)d0);
  goto l9;
l6:
  if (!((i2>=12 && i2<=15))) goto l7;
  i1 = (int)*SymbolFile__Write_w;
  i0 = (int)obj + 52;
  i0 = (int)*(void**)i0;
  i2 = *(int*)(i1-4);
  ...
  i0 = *(unsigned int*)i0;
  ((_TBP_BinaryRider__WriterDesc_WriteSet)i2)((BinaryRider__Writer)i1, (unsigned int)i0);
  goto l9;
l7:
  if (!((i2>=18 && i2<=19))) goto l8;
  i0 = (int)obj + 52;
  i0 = (int)*(void**)i0;
  i2 = (int)*SymbolFile__Write_w;
  SymbolFile__WriteStringConst((BinaryRider__Writer)i2, (Data__Const)i0);
  goto l9;
l8:
  if (!(i2==20)) goto l9;
l9:
...
void SymbolFile__Write_WriteUsedImports(int *SymbolFile__Write_importIndex, BinaryRider__Writer *SymbolFile__Write_w) {
  ...
  i4 = (int)SymbolFile__Write_WriteUsedImports_GetModule((const unsigned char*)(int)_c1, 1);
  i0 = i4 == 0;
  if (i0) goto l1;
l0:
  i5 = i4 + 52;
  i0 = (int)*(void**)i5;
  i1 = i0 + 28;
  i2 = *SymbolFile__Write_importIndex;
  *(int*)i1 = i2;
  i0 = *SymbolFile__Write_importIndex;
  i0++;
  *SymbolFile__Write_importIndex = i0;
  i0 = i4 + 20;
  i1 = (int)*(void**)i0;
  i2 = (int)*SymbolFile__Write_w;
  i3 = *(int*)(i1-8);
  SymbolFile__WriteString((BinaryRider__Writer)i2, (unsigned char*)i1, i3);
  i1 = (int)*(void**)i5;
  i5 = (int)*SymbolFile__Write_w;
  i1 += 24;
  i2 = *(int*)(i5-4);
  i1 = *(int*)i1;
  i2 = (int)((_Type)i2)->tbprocs[12];
  ((_TBP_BinaryRider__WriterDesc_WriteLInt)i2)((BinaryRider__Writer)i5, (int)i1);
  i0 = (int)*(void**)i0;
  i5 = *(int*)(i0-8);
  i4 = (int)SymbolFile__Write_WriteUsedImports_GetModule((const unsigned char*)i0, i5);
  i5 = i4 != 0;
  if (i5) goto l0;
l1:
  ;
...
void SymbolFile__Write_WriteOtherImports(Data__Object obj, BinaryRider__Writer *SymbolFile__Write_w) {
  ...
  i3 = (int)obj + 32;
  i3 = (int)*(void**)i3;
  SymbolFile__Write_WriteOtherImports((Data__Object)i3, (BinaryRider__Writer *)&*SymbolFile__Write_w);
  i3 = (int)obj + 28;
  i3 = *(signed char*)i3;
  i3 = i3 != 8;
  if (i3) goto l0;
  ...
  i4 = (int)*(void**)i0;
  i0 = *(int*)(i4-8);
  i2 = (int)SymbolFile__FindImportedModule((const unsigned char*)i4, i0);
  i1 = i2 + 64;
  i3 = *(unsigned int*)i1;
  i3 = (i3 & ((unsigned int)1 << 27)) != 0;
  if (i3) goto l0;
  i3 = (int)*SymbolFile__Write_w;
  SymbolFile__WriteString((BinaryRider__Writer)i3, (unsigned char*)i4, i0);
  i3 = i2 + 52;
  i4 = (int)*(void**)i3;
  i3 = (int)*SymbolFile__Write_w;
  i0 = i4 + 24;
  i4 = *(int*)(i3-4);
  i0 = *(int*)i0;
  i4 = (int)((_Type)i4)->tbprocs[12];
  ((_TBP_BinaryRider__WriterDesc_WriteLInt)i4)((BinaryRider__Writer)i3, (int)i0);
  i3 = *(unsigned int*)i1;
  i3 = i3 | ((unsigned int)1 << 27);
  *(unsigned int*)i1 = i3;
l0:
  i3 = (int)obj + 36;
  i3 = (int)*(void**)i3;
...
void SymbolFile__Write(Data__Object mod, unsigned char *newSymbolFile, unsigned char *symbolFileChanged) {
  ...
  *newSymbolFile = i1;
  ...
  i5 = (int)Files__Tmp((const unsigned char*)(int)fileName, 256, (unsigned int)0x3U, (Msg__Msg *)(int)&res);
  i0 = i5 == 0;
  if (i0) goto l7;
  i3 = (int)BinaryRider__ConnectWriter((Channel__Channel)i5);
  i1 = *(int*)(i3-4);
  i2 = (int)((_Type)i1)->tbprocs[3];
  i1 = (int)((_Type)i1)->tbprocs[12];
  ((_TBP_BinaryRider__WriterDesc_WriteBytes)i2)((BinaryRider__Writer)i3, (unsigned char*)(int)SymbolFile__symbolFileId, 5, (int)0, (int)4);
  ((_TBP_BinaryRider__WriterDesc_WriteLInt)i1)((BinaryRider__Writer)i3, (int)0);
  i2 = (int)*(void**)i4;
  i4 = *(int*)(i2-8);
  SymbolFile__WriteString((BinaryRider__Writer)i3, (unsigned char*)i2, i4);
  i2 = (int)SymbolTable__importedMods;
  SymbolFile__Write_ClearImportedMods((Data__Object)i2);
  i2 = (int)mod + 44;
  i2 = (int)*(void**)i2;
  SymbolFile__Write_MarkExportedObjects((Data__Object)i2, (Data__Object *)&mod);
  importIndex = (int)32;
  w = (void*)i3;
  importIndex = (int)32;
  w = (void*)i3;
  ...
  i2 = (int)*(void**)i3;
  SymbolFile__Write_WriteOtherImports((Data__Object)i2, (BinaryRider__Writer *)&w);
  i2 = *(int*)((int)w-4);
  i1 = (int)((_Type)i2)->tbprocs[13];
  SymbolFile__WriteString((BinaryRider__Writer)(int)w, (unsigned char*)(int)SymbolFile__emptyString, 2);
  i4 = (int)mod + 64;
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i1)((BinaryRider__Writer)(int)w, (int)1);
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i1)((BinaryRider__Writer)(int)w, (int)4);
  i1 = *(unsigned int*)i4;
  i1 &= 0xFFFU;
  SymbolFile__WriteFlags((BinaryRider__Writer)(int)w, (unsigned int)i1);
  i1 = (int)mod + 68;
  i1 = *(unsigned int*)i1;
  i1 &= 0x7FU;
  SymbolFile__WriteFlags((BinaryRider__Writer)(int)w, (unsigned int)i1);
...
l0:
  ...
  i2 = ((_TBP_BinaryRider__WriterDesc_Pos)i2)((BinaryRider__Writer)(int)w);
  SymbolFile__structLen = 0;
  i3 = (int)*(void**)i3;
  SymbolFile__Write_WriteTree((Data__Object)i3, (BinaryRider__Writer *)&w);
  i3 = *(int*)((int)w-4);
  i4 = (int)((_Type)i3)->tbprocs[13];
  i1 = (int)((_Type)i3)->tbprocs[1];
  ((_TBP_BinaryRider__WriterDesc_WriteNum)i4)((BinaryRider__Writer)(int)w, (int)0);
  SymbolFile__Write_Fingerprint((Files__File)i5, (int)i2, (unsigned char*)(int)&magicId, 4);
  i3 = (int)((_Type)i3)->tbprocs[12];
  ((_TBP_BinaryRider__WriterDesc_SetPos)i1)((BinaryRider__Writer)(int)w, (int)4);
  i2 = (int)mod + 52;
  ((_TBP_BinaryRider__WriterDesc_WriteLInt)i3)((BinaryRider__Writer)(int)w, (int)magicId);
  i2 = (int)*(void**)i2;
  i3 = i2 + 24;
  *(int*)i3 = magicId;
  i3 = *newSymbolFile;
...
l3:
  i3 = *(int*)(i5-4);
  i2 = (int)((_Type)i3)->tbprocs[7];
  ((_TBP_Files__FileDesc_Register)i2)((Files__File)i5);
  i2 = (int)*(void**)i5;
  i4 = i2 == 0;
  if (i4) goto l4;
  i4 = *(int*)(i2-4);
  i4 = (int)((_Type)i4)->tbprocs[3];
  ((_TBP_Msg__MsgDesc_GetText)i4)((Msg__Msg)i2, (Msg__String)(int)msg, 256);
...
l4:
  ...
  ((_TBP_Files__FileDesc_Close)i3)((Files__File)i5);
  i2 = (int)*(void**)i5;
  i3 = i2 == 0;
  if (i3) goto l5;
  i3 = *(int*)(i2-4);
...
l5:
  i3 = SymbolFile__structLen;
  i1 = i3 - 1;
  i3 = i1 < 0;
  if (i3) goto l8;
  i0 = 0;
l6:
  i3 = (int)SymbolFile__structArray;
...
void SymbolFile__Read_ReadObject_ReadStruct_ReadObjList(Data__Object *obj, unsigned char parameter, BinaryRider__Reader *SymbolFile__Read_r, Data__Struct *SymbolFile__Read_ReadObject_ReadStruct_t, Parameter__Filename SymbolFile__Read_fileName, Data__Object *SymbolFile__Read_mod, struct SymbolFile__Read_ModuleListDesc* *SymbolFile__Read_modList) {
  ...
  ((_TBP_BinaryRider__ReaderDesc_ReadNum)i1)((BinaryRider__Reader)i0, (int *)(int)&mode);
  i0 = mode == 0;
  if (i0) goto l1;
  i1 = (int)SymbolFile__Read_ReadObject((int)mode, (BinaryRider__Reader *)&*SymbolFile__Read_r, SymbolFile__Read_fileName, (Data__Object *)&*SymbolFile__Read_mod, (struct SymbolFile__Read_ModuleListDesc* *)&*SymbolFile__Read_modList);
  *obj = (void*)i1;
  i1 = (int)*obj;
  i0 = (int)*SymbolFile__Read_ReadObject_ReadStruct_t;
  i2 = i1 + 40;
  *(void**)i2 = (void*)i0;
...
l3:
  i4 = (int)*SymbolFile__Read_r;
  i4 = (int)SymbolFile__ReadString((BinaryRider__Reader)i4);
  i3 = _abs(i5);
  i2 = *(int*)(i4-8);
  i6 = (int)SymbolTable__NewObject((const unsigned char*)i4, i2, (signed char)i3, (int)-1);
  i4 = i6 + 64;
  i3 = (int)*SymbolFile__Read_mod;
  i3 += 48;
  i2 = i6 + 48;
  i3 = *(short int*)i3;
  *(short int*)i2 = i3;
  ...
  i0 = *(unsigned int*)i3;
  i2 = (int)*SymbolFile__Read_r;
  SymbolFile__ReadFlags((BinaryRider__Reader)i2, (unsigned int *)i3);
  i3 = (int)SymbolFile__Read_ReadObject_ReadStruct((BinaryRider__Reader *)&*SymbolFile__Read_r, (struct SymbolFile__Read_ModuleListDesc* *)&*SymbolFile__Read_modList, SymbolFile__Read_fileName, (Data__Object *)&*SymbolFile__Read_mod);
  *(void**)i1 = (void*)i3;
  i4 = *(unsigned int*)i4;
  i4 = (i4 & ((unsigned int)1 << 3)) != 0;
  if (!(i4)) goto l4;
  i4 = (int)*SymbolFile__Read_r;
  SystemFlags__ReadObjectInfo((BinaryRider__Reader)i4, (Data__Object)i6);
l4:
  i4 = i5 == -2;
  if (i4) goto l11;
  i2 = i5 == 1;
  ...
  i4 = *(int*)i3;
  i0 = (int)((_Type)i0)->tbprocs[14];
  ((_TBP_BinaryRider__ReaderDesc_ReadNum)i0)((BinaryRider__Reader)i2, (int *)i3);
  i2 = i6 + 52;
  i3 = (int)SymbolFile__Read_ReadObject((int)(-2147483647-1), (BinaryRider__Reader *)&*SymbolFile__Read_r, SymbolFile__Read_fileName, (Data__Object *)&*SymbolFile__Read_mod, (struct SymbolFile__Read_ModuleListDesc* *)&*SymbolFile__Read_modList);
  *(void**)i2 = (void*)i3;
  goto l12;
l5:
  i2 = i6 + 52;
  ...
  i3 += 20;
  i3 = *(signed char*)i3;
  if (!((i3>=1 && i3<=7))) goto l6;
  i4 = (int)*SymbolFile__Read_r;
  i3 = *(int*)(i4-4);
  i3 = (int)((_Type)i3)->tbprocs[14];
  ((_TBP_BinaryRider__ReaderDesc_ReadNum)i3)((BinaryRider__Reader)i4, (int *)(int)&valInt);
  i3 = (int)*(void**)i1;
  i3 += 20;
  i3 = *(signed char*)i3;
  ...
  i3 = (int)*(void**)i4;
  i3 = (int)Data__GetIntConst((int)valInt, (Data__Struct)i3);
  *(void**)i2 = (void*)i3;
  goto l10;
l6:
  if (!((i3>=8 && i3<=9))) goto l7;
  i3 = (int)*SymbolFile__Read_r;
  i4 = *(int*)(i3-4);
  i4 = (int)((_Type)i4)->tbprocs[16];
  ((_TBP_BinaryRider__ReaderDesc_ReadLReal)i4)((BinaryRider__Reader)i3, (double *)(int)&valReal);
  i4 = (int)*(void**)i1;
  i4 += 20;
  i4 = *(signed char*)i4;
  ...
  i4 = (int)*(void**)i3;
  i4 = (int)Data__GetRealConst((double)valReal, (Data__Struct)i4);
  *(void**)i2 = (void*)i4;
  goto l10;
l7:
  if (!((i3>=12 && i3<=15))) goto l8;
  i4 = (int)*SymbolFile__Read_r;
  i3 = *(int*)(i4-4);
  i3 = (int)((_Type)i3)->tbprocs[17];
  ((_TBP_BinaryRider__ReaderDesc_ReadSet)i3)((BinaryRider__Reader)i4, (unsigned int *)(int)&valSet);
  i3 = (int)*(void**)i1;
  i3 += 20;
  i3 = *(signed char*)i3;
  i4 = (int)_ashl(i3, 2, (unsigned int));
  i4 = (int)Data__struct + i4;
  i3 = (int)*(void**)i4;
  i3 = (int)Data__GetSetConst((unsigned int)valSet, (Data__Struct)i3);
  *(void**)i2 = (void*)i3;
  goto l10;
l8:
  if (!((i3>=18 && i3<=19))) goto l9;
  i4 = (int)*SymbolFile__Read_r;
  i4 = (int)SymbolFile__ReadStringConst((BinaryRider__Reader)i4, (signed char)i3);
  *(void**)i2 = (void*)i4;
  goto l10;
l9:
  if (!(i3==20)) goto l10;
...
l12:
  ...
  if (i5) goto l15;
l13:
  SymbolTable__MakeFormalParsLocal((Data__Object)i6);
  goto l15;
l14:
  i6 = (int)SymbolTable__NewObject((const unsigned char*)(int)_c10, 4, (signed char)9, (int)-1);
...
void SymbolFile__Read_ReadImportList(Data__Object *list, struct SymbolFile__Read_ModuleListDesc* *modList, BinaryRider__Reader *SymbolFile__Read_r, int *SymbolFile__Read_pos, unsigned char* SymbolFile__Read_moduleName, int SymbolFile__Read_moduleName_0d) {
  ...
  int magic;
  i0 = (int)*SymbolFile__Read_r;
  i4 = (int)SymbolFile__ReadString((BinaryRider__Reader)i0);
  i0 = strcmp((const char*) i4, (const char*) (int)_c1) == 0;
  if (i0) goto l2;
  i2 = (int)*SymbolFile__Read_r;
  i3 = *(int*)(i2-4);
  i3 = (int)((_Type)i3)->tbprocs[13];
  ((_TBP_BinaryRider__ReaderDesc_ReadLInt)i3)((BinaryRider__Reader)i2, (int *)(int)&magic);
  i1 = *(int*)(i4-8);
  i3 = *SymbolFile__Read_pos;
  i3 = (int)SymbolFile__Read((const unsigned char*)i4, i1, (int)i3);
  *list = (void*)i3;
  i2 = (int)*list;
  i3 = i2 == 0;
  if (i3) goto l1;
  ...
  i2 = magic == i2;
  if (i2) goto l0;
  i2 = *SymbolFile__Read_pos;
  Error__ErrIns2((int)i2, (short int)302, (const unsigned char*)(int)SymbolFile__Read_moduleName, SymbolFile__Read_moduleName_0d, (const unsigned char*)i4, i1);
l0:
  {
    char *_mem, *_var;
  ...
  *(void**)i1 = (void*)i4;
  ...
  i4 = (int)*(void**)i2;
  i0 = (int)*(void**)i1;
  SymbolFile__Read_ReadImportList((Data__Object *)i1, (struct SymbolFile__Read_ModuleListDesc* *)i2, (BinaryRider__Reader *)&*SymbolFile__Read_r, &*SymbolFile__Read_pos, SymbolFile__Read_moduleName, SymbolFile__Read_moduleName_0d);
  goto l5;
l1:
...
l3:
  i3 = (int)*SymbolFile__Read_r;
  i3 = (int)SymbolFile__ReadString((BinaryRider__Reader)i3);
  i1 = strcmp((const char*) i3, (const char*) (int)_c1) == 0;
  if (i1) goto l4;
  i0 = (int)*SymbolFile__Read_r;
  i3 = *(int*)(i0-4);
  i3 = (int)((_Type)i3)->tbprocs[13];
  magic = (int)i2;
  magic = (int)i2;
  ((_TBP_BinaryRider__ReaderDesc_ReadLInt)i3)((BinaryRider__Reader)i0, (int *)(int)&magic);
  i2 = magic;
l4:
  if (!(i1)) goto l3;
  *list = (void*)0;
...
l3:
  ...
  *(short int*)i8 = 0;
  i4 = i12 + 32;
  i5 = i12 + 36;
  i6 = (int)SymbolTable__importedMods;
  *(void**)i5 = (void*)i6;
